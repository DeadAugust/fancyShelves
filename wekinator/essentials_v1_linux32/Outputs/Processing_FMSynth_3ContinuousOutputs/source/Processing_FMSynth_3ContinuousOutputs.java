...
public class Processing_FMSynth_3ContinuousOutputs extends PApplet {
...
float modulateAmount = 0.1f; //0 to 500 ; 132
float modulateFrequency = 0.1f; // 0 to 500 ; 50
float offset = 0.4f; //0 to 500; 200
...
public void setup() {
  ...
  Oscil wave = new Oscil( 200, 0.8f, Waves.SINE );
...
public void sendOsc() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Processing_FMSynth_3ContinuousOutputs" };
    if (passedArgs != null) {
